...
ActivityPub-native. MIT. Self-hostable.

> **Custody note:** actor keys are generated by the node, encrypted at rest
> under a node master key, and used for AP signing/delivery. This is secure
> **node custody** of per-actor identities — not self-custodial key control.
> Import/export of keys may come later; do not assume it exists today.
